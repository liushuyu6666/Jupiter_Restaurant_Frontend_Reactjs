...
class ShopAdd extends Component{
    ...
    constructor(props) {
        ...
        this.state = {
            formValue: {
                shopName: "", desc: "", imgUrl: "", categories: [], ownerId: "",
    ...
    save = () => {
        ...
        createShop(token, updatingValue)
            .then(res => {
                if(res.result != null){
                    window.alert("create shop entity in the database successfully, image uploading...");
                        ...
                        createImage(res.result.id, this.state.auxiliaryValue.image)
                            .then(imgRes => {
                                if(imgRes.result != null){
                                    window.alert("create shop successfully");
                                    resetServer();
                    ...
                    window.alert(`add new shop in the database failed: ${res.msg}`);
                }
            })
            .catch(err => {
